<nav id="sidebarMenu" class="sidebar d-md-block bg-primary text-white collapse" data-simplebar>
    <div class="sidebar-inner pt-3">
        <ul class="nav flex-column">
            <li class="nav-item {{ Request::segment(2) == 'services' ? 'active' : '' }}"><a href="{{ route('categories.index') }}" class="nav-link"><span class="sidebar-icon"><span class="fas fa-cog"></span></span> <span>{{ __('messages.services') }}</span></a></li>
