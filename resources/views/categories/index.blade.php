    ...
    <div class="row align-items-center justify-content-between mb-2">
        ...
        <div class="col col-sm-6 text-left">
            <a class="btn btn-success" href="{{ route('categories.create') }}">
                <i class="fa fa-plus"></i> {{ __('messages.create_category') }}
            </a>
        </div>
                        ...
                        <td>
                            <div class="btn-group"><button class="btn btn-link text-dark dropdown-toggle dropdown-toggle-split m-0 p-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('categories.show', $category) }}"><span class="fas fa-eye mr-2"></span>{{ __('messages.view') }}</a>
                                    <a class="dropdown-item" href="{{ route('categories.edit', $category) }}"><span class="fas fa-edit mr-2"></span>{{ __('messages.edit') }}</a>
                                </div>
                            </div>
                        </td>
                    </tr>
